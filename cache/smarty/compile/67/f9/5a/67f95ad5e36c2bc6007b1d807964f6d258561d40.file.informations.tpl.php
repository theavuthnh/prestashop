<?php /* Smarty version Smarty-3.1.14, created on 2014-06-24 04:13:17
         compiled from "/var/www/html/ps/blog/admin/themes/default/template/controllers/products/informations.tpl" */ ?>
<?php /*%%SmartyHeaderCode:133885015753a8fadda18619-21883755%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '67f95ad5e36c2bc6007b1d807964f6d258561d40' => 
    array (
      0 => '/var/www/html/ps/blog/admin/themes/default/template/controllers/products/informations.tpl',
      1 => 1397128152,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '133885015753a8fadda18619-21883755',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_53a8fade1d1433_53116799',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_53a8fade1d1433_53116799')) {function content_53a8fade1d1433_53116799($_smarty_tpl) {?>
...
" <?php if ($_smarty_tpl->tpl_vars['product_type']->value==Product::PTYPE_PACK){?>checked="checked"<?php }?> />
					<?php echo smartyTranslate(array('s'=>'Pack of existing products'),$_smarty_tpl);?>
...
">
			<span class="label-tooltip" data-toggle="tooltip"
				title="<?php echo smartyTranslate(array('s'=>'The public name for this product.'),$_smarty_tpl);?>
...
" />
	...
	<div class="form-group">
		<label class="control-label col-lg-3" for="ean13">
			<span class="label-tooltip" data-toggle="tooltip"
				title="<?php echo smartyTranslate(array('s'=>'This type of product code that is specific to Europe and Japan, but is widely used internationally. It is a superset of the UPC code: all products marked with an EAN will be accepted in North America.'),$_smarty_tpl);?>
">
				<?php echo $_smarty_tpl->tpl_vars['bullet_common_field']->value;?>
...
';
			...
			<div class="form-group">
				<label class="control-label col-lg-3" for="available_for_order">
					<?php if (isset($_smarty_tpl->tpl_vars['display_multishop_checkboxes']->value)&&$_smarty_tpl->tpl_vars['display_multishop_checkboxes']->value){?>
						<?php echo $_smarty_tpl->getSubTemplate ("controllers/products/multishop/checkbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('only_checkbox'=>"true",'field'=>"available_for_order",'type'=>"default"), 0);?>

						<?php echo $_smarty_tpl->getSubTemplate ("controllers/products/multishop/checkbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('only_checkbox'=>"true",'field'=>"show_price",'type'=>"show_price"), 0);?>

						<?php echo $_smarty_tpl->getSubTemplate ("controllers/products/multishop/checkbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('only_checkbox'=>"true",'field'=>"online_only",'type'=>"default"), 0);?>
				...
				<div class="col-lg-5">
					<p class="checkbox">
						...
						<label for="available_for_order"><?php echo smartyTranslate(array('s'=>'Available for order'),$_smarty_tpl);?>
</label>
					</p>
					<p class="checkbox">	
						...
						<label for="show_price"><?php echo smartyTranslate(array('s'=>'Show price'),$_smarty_tpl);?>
</label>
					</p>
					<p class="checkbox">
						...
						<label for="online_only"><?php echo smartyTranslate(array('s'=>'Online only (not sold in your retail store)'),$_smarty_tpl);?>
</label>
					</p>
				</div>
			</div>
	...
	<div class="form-group">
		<label class="control-label col-lg-3" for="description_short_<?php echo $_smarty_tpl->tpl_vars['id_lang']->value;?>
">
			...
			<span class="label-tooltip" data-toggle="tooltip"
				title="<?php echo smartyTranslate(array('s'=>'Appears in the product list(s), and at the top of the product page.'),$_smarty_tpl);?>
">
	...
	<div class="form-group">
		<label class="control-label col-lg-3" for="description_<?php echo $_smarty_tpl->tpl_vars['id_lang']->value;?>
">
...
">
		...
		<div class="col-lg-9">
			<?php echo $_smarty_tpl->getSubTemplate ("controllers/products/textarea_lang.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('languages'=>$_smarty_tpl->tpl_vars['languages']->value,'input_name'=>'description','class'=>"autoload_rte",'input_value'=>$_smarty_tpl->tpl_vars['product']->value->description), 0);?>

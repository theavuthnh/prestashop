<?php /* Smarty version Smarty-3.1.14, created on 2014-06-24 04:13:27
         compiled from "/var/www/html/ps/blog/admin/themes/default/template/controllers/import/helpers/form/form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:130896921053a8fae793b890-43282581%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2fc3dae0dac859b377bf6f875afd2e501ba3e62e' => 
    array (
      0 => '/var/www/html/ps/blog/admin/themes/default/template/controllers/import/helpers/form/form.tpl',
      1 => 1397128152,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '130896921053a8fae793b890-43282581',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_53a8fae7cd80f1_84027196',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_53a8fae7cd80f1_84027196')) {function content_53a8fae7cd80f1_84027196($_smarty_tpl) {?>
...
"<?php if ($_smarty_tpl->tpl_vars['entity_selected']->value==$_smarty_tpl->tpl_vars['i']->value){?> selected="selected"<?php }?>>
				...
				<div class="alert alert-warning import_products_categories">
					<ul>
						<li><?php echo smartyTranslate(array('s'=>'Note that the category import does not support categories of the same name.'),$_smarty_tpl);?>
</li>
				...
				<div class="form-group" id="csv_file_uploader">
					<label for="file" class="control-label col-lg-4"><?php echo smartyTranslate(array('s'=>'Select your CSV file'),$_smarty_tpl);?>
</label>
					<div class="col-lg-8">
						<input id="file" type="file" name="file" data-url="<?php echo $_smarty_tpl->tpl_vars['current']->value;?>
&amp;token=<?php echo $_smarty_tpl->tpl_vars['token']->value;?>
&amp;ajax=1&amp;action=uploadCsv" class="hide" />
						<button class="ladda-button btn btn-default" data-style="expand-right" data-size="s" type="button" id="file-add-button">
							...
							<?php echo smartyTranslate(array('s'=>'Add file'),$_smarty_tpl);?>
...
<?php }else{ ?>,<?php }?>" />
						<div class="help-block"><?php echo smartyTranslate(array('s'=>'e.g. '),$_smarty_tpl);?>
 Ipod; red.jpg, blue.jpg, green.jpg; 129.90</div>
					</div>
				</div>
				<hr>
				<div class="form-group">
 ...
 <span id="entitie"><?php echo smartyTranslate(array('s'=>'categories'),$_smarty_tpl);?>
				...
				<div class="form-group" style="display: none">
					<label for="match_ref" class="control-label col-lg-4"><?php echo smartyTranslate(array('s'=>'Use product reference as key?'),$_smarty_tpl);?>
</label>
					<div class="col-lg-8">
						<label class="switch-light prestashop-switch fixed-width-lg">
				...
				<div class="form-group">
					<label for="regenerate" class="control-label col-lg-4"><?php echo smartyTranslate(array('s'=>'No thumbnails regeneration'),$_smarty_tpl);?>
</label>
					<div class="col-lg-8">
						<label class="switch-light prestashop-switch fixed-width-lg">
				...
				<div class="form-group">
					<label for="forceIDs" class="control-label col-lg-4">
						<span data-toggle="tooltip" class="label-tooltip" data-original-title="<?php echo smartyTranslate(array('s'=>'If you don\'t use this option, all ID\'s will be auto-incremented.'),$_smarty_tpl);?>
">
							<?php echo smartyTranslate(array('s'=>'Force all ID'),$_smarty_tpl);?>
		...
		<div class="panel">
			...
			<div class="list-group">
				...
				<a class="list-group-item" href="../docs/csv_import/alias_import.csv" target="_blank">
					<?php echo smartyTranslate(array('s'=>'Sample Alias file'),$_smarty_tpl);?>
				...
				<a class="list-group-item" href="../docs/csv_import/supply_orders_import.csv" target="_blank">
					<?php echo smartyTranslate(array('s'=>'Supply Orders sample file'),$_smarty_tpl);?>

				</a>
				<a class="list-group-item" href="../docs/csv_import/supply_orders_details_import.csv" target="_blank">
					<?php echo smartyTranslate(array('s'=>'Supply Orders Details sample file'),$_smarty_tpl);?>
				...
				if (data.result) {
					if (typeof data.result.file !== 'undefined') {
						if (typeof data.result.file.error !== 'undefined' && data.result.file.error != '')
							...
							row.find('a.csv-download-link').attr('href','<?php echo $_smarty_tpl->tpl_vars['current']->value;?>
&token=<?php echo $_smarty_tpl->tpl_vars['token']->value;?>
&csvfilename='+filename);
							row.find('a.csv-delete-link').attr('href','<?php echo $_smarty_tpl->tpl_vars['current']->value;?>
&token=<?php echo $_smarty_tpl->tpl_vars['token']->value;?>

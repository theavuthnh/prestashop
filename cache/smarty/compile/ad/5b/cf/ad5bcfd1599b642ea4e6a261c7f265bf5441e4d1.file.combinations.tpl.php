<?php /* Smarty version Smarty-3.1.14, created on 2014-06-24 04:13:16
         compiled from "/var/www/html/ps/blog/admin/themes/default/template/controllers/products/combinations.tpl" */ ?>
<?php /*%%SmartyHeaderCode:135841184853a8fadcf164a7-23372337%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ad5bcfd1599b642ea4e6a261c7f265bf5441e4d1' => 
    array (
      0 => '/var/www/html/ps/blog/admin/themes/default/template/controllers/products/combinations.tpl',
      1 => 1397128152,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '135841184853a8fadcf164a7-23372337',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_53a8fadd47df11_12324079',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_53a8fadd47df11_12324079')) {function content_53a8fadd47df11_12324079($_smarty_tpl) {?>
 ...
 .-_#">
		...
		<div class="form-group">
			<label class="control-label col-lg-3" for="attribute_wholesale_price">
				...
				<span class="label-tooltip" data-toggle="tooltip"
					title="<?php echo smartyTranslate(array('s'=>'Set to zero if the price does not change.'),$_smarty_tpl);?>
">
...
<?php }?>
		...
		<div class="form-group">
			<label class="control-label col-lg-3" for="attribute_ecotax">
				...
				<span class="label-tooltip" data-toggle="tooltip"
					title="<?php echo smartyTranslate(array('s'=>'Overrides the ecotax from the "Prices" tab.'),$_smarty_tpl);?>
">
...
<?php }?>
		...
		<div class="form-group">
			<label class="control-label col-lg-3" for="attribute_minimal_quantity">
				...
				<span class="label-tooltip" data-toggle="tooltip"
					title="<?php echo smartyTranslate(array('s'=>'The minimum quantity to buy this product (set to 1 to disable this feature).'),$_smarty_tpl);?>
">
...
" />
		...
		<div class="form-group">
			<label class="control-label col-lg-3" for="available_date_attribute">
				...
				<span class="label-tooltip" data-toggle="tooltip"
					title="<?php echo smartyTranslate(array('s'=>'If this product is out of stock, you can indicate when the product will be available again.'),$_smarty_tpl);?>
">

<?php /* Smarty version Smarty-3.1.14, created on 2014-06-24 11:45:20
         compiled from "/var/www/html/ps/blog/admin7004/themes/default/template/controllers/themes/helpers/options/options.tpl" */ ?>
<?php /*%%SmartyHeaderCode:92831257853a90260d59dd2-31869502%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8146cab1089656b00b166c1533a6cb1607bf5119' => 
    array (
      0 => '/var/www/html/ps/blog/admin7004/themes/default/template/controllers/themes/helpers/options/options.tpl',
      1 => 1397128152,
      2 => 'file',
    ),
    'cb52406150f6ff3fdd0c657326ac065249c5af98' => 
    array (
      0 => '/var/www/html/ps/blog/admin7004/themes/default/template/helpers/options/options.tpl',
      1 => 1397128152,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '92831257853a90260d59dd2-31869502',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_53a90261b9ce79_16791640',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_53a90261b9ce79_16791640')) {function content_53a90261b9ce79_16791640($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include '/var/www/html/ps/blog/tools/smarty/plugins/modifier.replace.php';
?>
...
?>
					<div class="col-lg-2 <?php if ($_smarty_tpl->tpl_vars['theme']->value->id==$_smarty_tpl->tpl_vars['field']->value['id_theme']){?>select_theme_choice<?php }?>" onclick="$(this).find('input').attr('checked', true); $('.select_theme').removeClass('select_theme_choice'); $(this).toggleClass('select_theme_choice');">
						<div class="radio">
							<label>
								<input type="radio" name="id_theme" value="<?php echo $_smarty_tpl->tpl_vars['theme']->value->id;?>
" <?php if ($_smarty_tpl->tpl_vars['theme']->value->id==$_smarty_tpl->tpl_vars['field']->value['id_theme']){?>checked="checked"<?php }?> /> <?php echo $_smarty_tpl->tpl_vars['theme']->value->name;?>

							</label>
						</div>
						<div class="theme_container">
							<img class="img-thumbnail" src="../themes/<?php echo $_smarty_tpl->tpl_vars['theme']->value->directory;?>

<?php /* Smarty version Smarty-3.1.14, created on 2014-06-24 04:13:19
         compiled from "/var/www/html/ps/blog/admin/themes/default/template/controllers/products/prices.tpl" */ ?>
<?php /*%%SmartyHeaderCode:71447412853a8fadf7c8eb1-44912797%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '40c082e025e035c0ca3d057b92643ee36649d852' => 
    array (
      0 => '/var/www/html/ps/blog/admin/themes/default/template/controllers/products/prices.tpl',
      1 => 1397128152,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '71447412853a8fadf7c8eb1-44912797',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_53a8fadfe0d648_57794347',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_53a8fadfe0d648_57794347')) {function content_53a8fadfe0d648_57794347($_smarty_tpl) {?>
	...
	<div class="form-group">
		<label class="control-label col-lg-3" for="wholesale_price">
			...
			<span class="label-tooltip" data-toggle="tooltip"
				title="<?php echo smartyTranslate(array('s'=>'The wholesale price is the price you paid for the product. Do not include the tax.'),$_smarty_tpl);?>
">
				<?php echo smartyTranslate(array('s'=>'Pre-tax wholesale price'),$_smarty_tpl);?>
...
" onchange="this.value = this.value.replace(/,/g, '.');" />
	...
	<div class="form-group">
		<label class="control-label col-lg-3" for="priceTE">
			...
			<span class="label-tooltip" data-toggle="tooltip"
				title="<?php echo smartyTranslate(array('s'=>'The pre-tax retail price is the price for which you intend sell this product to your customers. It should be higher than the pre-tax wholesale price: the difference between the two will be your margin.'),$_smarty_tpl);?>
">
				<?php echo smartyTranslate(array('s'=>'Pre-tax retail price'),$_smarty_tpl);?>
...
" name="id_tax_rules_group" />
	...
	<div class="form-group" <?php if (!$_smarty_tpl->tpl_vars['ps_use_ecotax']->value){?> style="display:none;"<?php }?>>
		<label class="control-label col-lg-3" for="ecotax">
			...
			<span class="label-tooltip" data-toggle="tooltip"
				title="<?php echo smartyTranslate(array('s'=>'The ecotax is a local set of taxes intended to "promote ecologically sustainable activities via economic incentives". It is already included in retail price: the higher this ecotax is, the lower your margin will be.'),$_smarty_tpl);?>
">
...
<?php echo $_smarty_tpl->tpl_vars['currency']->value->suffix;?>
			...
			<input maxlength="14" id="ecotax" name="ecotax" type="text" value="<?php echo sprintf('%.2f',$_smarty_tpl->tpl_vars['product']->value->ecotax);?>
...
<?php echo $_smarty_tpl->tpl_vars['currency']->value->suffix;?>
	...
	<div class="form-group">
		<label class="control-label col-lg-3" for="unit_price">
			...
			<span class="label-tooltip" data-toggle="tooltip"
				title="<?php echo smartyTranslate(array('s'=>'When selling a pack of items, you can indicate the unit price for each item of the pack. For instance, "per bottle" or "per pound".'),$_smarty_tpl);?>
">
...
<?php echo $_smarty_tpl->tpl_vars['currency']->value->suffix;?>
			...
			<input maxlength="14" id="unit_price" name="unit_price" type="text" value="<?php echo sprintf('%.2f',$_smarty_tpl->tpl_vars['unit_price']->value);?>
" onkeyup="if (isArrowKey(event)) return ;this.value = this.value.replace(/,/g, '.'); unitPriceWithTax('unit');"/>
			...
			<input maxlength="10" id="unity" name="unity" type="text" value="<?php echo smarty_modifier_htmlentitiesUTF8($_smarty_tpl->tpl_vars['product']->value->unity);?>

<?php /* Smarty version Smarty-3.1.14, created on 2014-06-24 04:12:51
         compiled from "/var/www/html/ps/blog/themes/default-bootstrap/shopping-cart.tpl" */ ?>
<?php /*%%SmartyHeaderCode:57196544253a8fac3535a95-16990358%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1b3af9ff00103d9f1b359ea3aaa2d6d80e391128' => 
    array (
      0 => '/var/www/html/ps/blog/themes/default-bootstrap/shopping-cart.tpl',
      1 => 1397128152,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '57196544253a8fac3535a95-16990358',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_53a8fac4978757_85970009',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_53a8fac4978757_85970009')) {function content_53a8fac4978757_85970009($_smarty_tpl) {?>
...
<?php }?>
				...
				<?php if ($_smarty_tpl->tpl_vars['total_shipping_tax_exc']->value<=0&&!isset($_smarty_tpl->tpl_vars['virtualCart']->value)){?>
					<tr class="cart_total_delivery" style="<?php if (!isset($_smarty_tpl->tpl_vars['carrier']->value->id)||is_null($_smarty_tpl->tpl_vars['carrier']->value->id)){?>display:none;<?php }?>">
						<td colspan="3" class="text-right"><?php echo smartyTranslate(array('s'=>'Shipping'),$_smarty_tpl);?>
</td>
...
<?php }?></td>
				...
				<?php if ($_smarty_tpl->tpl_vars['use_taxes']->value&&$_smarty_tpl->tpl_vars['show_taxes']->value){?>
					<tr class="cart_total_price">
						<td colspan="3" class="text-right"><?php echo smartyTranslate(array('s'=>'Total (tax excl.)'),$_smarty_tpl);?>
</td>
					...
					<tr class="cart_total_tax">
						<td colspan="3" class="text-right"><?php echo smartyTranslate(array('s'=>'Total tax'),$_smarty_tpl);?>
</td>
...
?>
									<?php if (isset($_smarty_tpl->tpl_vars['address']->value['formated'][$_smarty_tpl->tpl_vars['key']->value])&&!empty($_smarty_tpl->tpl_vars['address']->value['formated'][$_smarty_tpl->tpl_vars['key']->value])){?>
										<?php if ((!$_smarty_tpl->tpl_vars['addedli']->value)){?>
											<?php $_smarty_tpl->tpl_vars['addedli'] = new Smarty_variable(true, null, 0);?>
											<li><span class="<?php if (isset($_smarty_tpl->tpl_vars['addresses_style']->value[$_smarty_tpl->tpl_vars['key']->value])){?><?php echo $_smarty_tpl->tpl_vars['addresses_style']->value[$_smarty_tpl->tpl_vars['key']->value];?>
<?php }?>">
										<?php }?>
										<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['address']->value['formated'][$_smarty_tpl->tpl_vars['key']->value], ENT_QUOTES, 'UTF-8', true);?>

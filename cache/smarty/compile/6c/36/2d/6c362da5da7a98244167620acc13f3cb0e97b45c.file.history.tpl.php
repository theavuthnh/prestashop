<?php /* Smarty version Smarty-3.1.14, created on 2014-06-24 04:13:04
         compiled from "/var/www/html/ps/blog/themes/default-bootstrap/history.tpl" */ ?>
<?php /*%%SmartyHeaderCode:47708041053a8fad063b407-55144538%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6c362da5da7a98244167620acc13f3cb0e97b45c' => 
    array (
      0 => '/var/www/html/ps/blog/themes/default-bootstrap/history.tpl',
      1 => 1397128152,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '47708041053a8fad063b407-55144538',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_53a8fad0a97ee6_27937934',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_53a8fad0a97ee6_27937934')) {function content_53a8fad0a97ee6_27937934($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_regex_replace')) include '/var/www/html/ps/blog/tools/smarty/plugins/modifier.regex_replace.php';
?>
...
">
						...
						<td data-value="<?php echo $_smarty_tpl->tpl_vars['order']->value['id_order_state'];?>
" class="history_state">
							<?php if (isset($_smarty_tpl->tpl_vars['order']->value['order_state'])){?>
								<span class="label<?php if ($_smarty_tpl->tpl_vars['order']->value['id_order_state']==1||$_smarty_tpl->tpl_vars['order']->value['id_order_state']==10||$_smarty_tpl->tpl_vars['order']->value['id_order_state']==11){?> label-info<?php }elseif($_smarty_tpl->tpl_vars['order']->value['id_order_state']==5||$_smarty_tpl->tpl_vars['order']->value['id_order_state']==2||$_smarty_tpl->tpl_vars['order']->value['id_order_state']==12){?> label-success<?php }elseif($_smarty_tpl->tpl_vars['order']->value['id_order_state']==6||$_smarty_tpl->tpl_vars['order']->value['id_order_state']==7||$_smarty_tpl->tpl_vars['order']->value['id_order_state']==8){?> label-danger<?php }elseif($_smarty_tpl->tpl_vars['order']->value['id_order_state']==3||$_smarty_tpl->tpl_vars['order']->value['id_order_state']==9||$_smarty_tpl->tpl_vars['order']->value['id_order_state']==4){?> label-warning<?php }?>" <?php if ($_smarty_tpl->tpl_vars['order']->value['id_order_state']>12){?>style="background-color:<?php echo $_smarty_tpl->tpl_vars['order']->value['order_state_color'];?>
;"<?php }?>>
...
<i class="icon-chevron-right right"></i>
							...
							<?php if (isset($_smarty_tpl->tpl_vars['opc']->value)&&$_smarty_tpl->tpl_vars['opc']->value){?>
								<a class="link-button" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('order-opc',true,null,"submitReorder&id_order=".((string)$_smarty_tpl->tpl_vars['order']->value['id_order'])), ENT_QUOTES, 'UTF-8', true);?>
" title="<?php echo smartyTranslate(array('s'=>'Reorder'),$_smarty_tpl);?>
">
							<?php }else{ ?>
								<a class="link-button" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('order',true,null,"submitReorder&id_order=".((string)$_smarty_tpl->tpl_vars['order']->value['id_order'])), ENT_QUOTES, 'UTF-8', true);?>
" title="<?php echo smartyTranslate(array('s'=>'Reorder'),$_smarty_tpl);?>
">
							<?php }?>
